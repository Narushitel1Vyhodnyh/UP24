<div>
    {{-- Hero section start --}}
    <div class="w-full h-screen bg-slate-100 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Покоряй вершины вместе с нами!</h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400 font-medium">Лучший выбор в мире активного туризма, <span class="text-red-500 font-bold">МЫ</span> залог твоих покоренных вершин</p>
                ...
                <div class="relative ms-4">
                    <img class="w-full rounded-md"
                        src="https://assets.thenorthface.eu/image/upload/c_limit,w_1080/q_auto:best,f_auto:image/v1724248451/TNF-fw24-outlet-lp-m-men"
